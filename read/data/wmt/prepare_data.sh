...
cd .. && mv training/europarl* . 
# && rm -r training training-parallel-europarl-v7.tgz
...
cd .. && mv training-parallel-nc-v11/* . 
# && rm -r training-parallel-nc-v11 training-parallel-nc-v11.tgz
...
cd .. 
# && rm test-filtered.tgz test.tgz && cd ..
