...
from render import BitcoinTradingGraph
...
class BitcoinTradingEnv(gym.Env):
    ...
    def _take_action(self, action, current_price):
        ...
        if action_type < 1:
            ...
            btc_bought = self.btc_held * amount
    ...
    def render(self, mode='human', **kwards):
        if mode == 'system':
        ...
        if mode == 'human':
            if self.viewer == None:
                self.viewer = BitcoinTradingGraph(self.df, kwards.get('title', None))
